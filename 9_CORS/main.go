// GET - curl request - curl http://localhost:9090/products
// POST - curl -X POST "http://localhost:9090/products" -H "Content-Type: application/json" -d "{\"id\":3,\"name\":\"Cappuccino\",\"description\":\"Coffee with steamed milk and foam\",\"price\":3.15,\"sku\":\"capp123\",\"createdOn\":\"2025-09-19T10:00:00Z\",\"updatedOn\":\"2025-09-19T10:00:00Z\"}"
// PUT - curl -X PUT http://localhost:9090/products/2 -H "Content-Type: application/json" -d '{"name":"Espresso Double Shot","description":"Extra strong coffee without milk","price":2.49,"sku":"fjd34"}'
